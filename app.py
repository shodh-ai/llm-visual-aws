...
async def get_visualization(request: VisualizationRequest):
    ...
    valid_topics = ['schema', 'parallel_db', 'hierarchical', 'network', 'er', 'document', 'history', 'xml', 'relational']
...
async def generate_narration(topic: str):
    ...
    try:
        if topic not in ['schema', 'parallel_db', 'hierarchical', 'network', 'er', 'document', 'history', 'xml', 'relational']:
